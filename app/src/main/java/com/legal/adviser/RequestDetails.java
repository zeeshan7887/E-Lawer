...
import com.legal.adviser.ClientSide.BookingActivity;
import com.legal.adviser.Models.AppointmentModel;
import com.legal.adviser.Models.RequestModel;
...
import com.legal.adviser.databinding.ActivityRequestDetailsBinding;
    ...
    private void UpdateRequestStatus(final String sts) {
        ...
        ref.updateChildren(updates).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    progressDialog.dismiss();
                    Toast.makeText(RequestDetails.this, "Request "+sts, Toast.LENGTH_SHORT).show();
