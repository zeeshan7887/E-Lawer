...
public class ClientChat extends AppCompatActivity{
    ...
    com.legal.adviser.databinding.ActivityClientChatBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = com.legal.adviser.databinding.ActivityClientChatBinding.inflate(getLayoutInflater());
