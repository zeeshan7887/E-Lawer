...
public class Qualification extends AppCompatActivity {
    ...
    private void INSERT_IN_DATABASE(String education, String cnic, String licence, String lowerCrt, String higherCrt, String vCrt, String hCrt, String lawerLang, String lawerCat, String chamberCity, String lawyerSpec) {
        ...
        QualificationModel values = new QualificationModel(auth.getCurrentUser().getUid(),education,cnic,licence,lowerCrt,higherCrt,vCrt,hCrt,lawerLang,lawerCat,chamberCity,lawyerSpec,shared.getString("IMAGE",""),shared.getString("NAME",""),shared.getString("PHONE",""),DateTime,"0");
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(Qualification.this, "Inserted", Toast.LENGTH_SHORT).show();
                            finish();
