...
public class ForgotPassword extends AppCompatActivity {
    ...
    public void SendSMS(final String email, String pin)
    {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(ForgotPassword.this,
                            "Mail sent successfully to "+email, Toast.LENGTH_LONG).show();
...
//                i.putExtra("STATUS", STATUS);
                    startActivity(i);
                    finish();
//                    Toast.makeText(ForgotPassword.this, "yes " + email, Toast.LENGTH_SHORT).show();
                    // do something when mail was sent successfully.
                } else {
//                    Toast.makeText(ForgotPassword.this, "No " + email, Toast.LENGTH_SHORT).show();
                    // ...
                }
            }
        });
